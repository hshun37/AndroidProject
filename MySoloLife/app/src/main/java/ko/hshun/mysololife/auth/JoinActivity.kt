...
import ko.hshun.mysololife.databinding.ActivityJoinBinding
...
class JoinActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.joinBtn.setOnClickListener {
            ...
            val password1 = binding.passwrodArea1.text.toString()
            val password2 = binding.passwrodArea2.text.toString()
